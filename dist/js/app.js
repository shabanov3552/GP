        ...
        projectMaps.forEach((mapBody => {
            ...
            mapBody.addEventListener("pointerdown", (event => {
                ...
                function moveAt(pageX, pageY, event) {
                    ...
                    mapBody.clientWidth, event.view.window.innerWidth;
                    mapBody.clientHeight, event.view.window.innerHeight;
                    ...
                    } else if (top < 0) mapBody.style.top = `${top}px`;
                    ...
                    } else if (left < 0) mapBody.style.left = `${left}px`;
                }
                function onMouseMove(event) {
                    moveAt(event.clientX, event.clientY, event);
