 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
                ...
                new swiper_core_Swiper(".mp-fb-main-slider", {
                    ...
                    on: {
                        ...
                        breakpoint: function(swiper, breakpointParams) {
                            if (!breakpointParams?.autoHeight) swiper.el.querySelector(".mp-fb-main-slider__wrapper").style.height = null;
                        }
                    }
                });
            }
            if (document.querySelector(".projects-block__slider")) window.lpSLider = new swiper_core_Swiper(".projects-block__slider", {
                modules: [ Navigation ],
                slidesPerView: 4,
                spaceBetween: 2,
                loop: true,
            ...
            if (document.querySelector(".docs-gallery__slider")) new swiper_core_Swiper(".docs-gallery__slider", {
                modules: [ Navigation, Pagination ],
                slidesPerView: 1,
                spaceBetween: 0,
                loop: true,
                navigation: {
                    prevEl: ".docs-gallery__slider .swiper-button-prev",
                    nextEl: ".docs-gallery__slider .swiper-button-next"
                },
                pagination: {
                    el: ".docs-gallery__slider .swiper-pagination",
                    type: "fraction"
                }
            });
        }
...
***************************************************************************** */
        ...
        document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".js-open-sidebar-catalog")) {
                if (!document.documentElement.classList.contains("menu-open")) bodyLockToggle();
        ...
        document.querySelectorAll(".projects-map__body").forEach((mapBody => {
            ...
            mapBody.addEventListener("pointerdown", (event => {
                ...
                const navHeight = document.querySelector(".projects-map__navigation").clientHeight;
                ...
                const moveAt = (pageX, pageY) => {
                    ...
                    if (mapHeight + navHeight > windowHeight) newTop = Math.max(windowHeight - mapHeight - navHeight, Math.min(newTop, 0)); else newTop = Math.max(0, Math.min(newTop, windowHeight - mapHeight - navHeight));
                    if (mapWidth > windowWidth) newLeft = Math.max(windowWidth - mapWidth, Math.min(newLeft, 0)); else newLeft = Math.max(0, Math.min(newLeft, windowWidth - mapWidth));
